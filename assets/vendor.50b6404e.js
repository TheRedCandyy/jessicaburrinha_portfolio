    ...
    update: {
      ...
      updateSlides: function () {
        ...
        for (let g = 0; g < p; g += 1) {
          ...
          const n = c.eq(g);
          if (
            (E && e.grid.updateSlide(g, n, p, t), "none" !== n.css("display"))
          ) {
            if ("auto" === i.slidesPerView) {
              ...
              (x = (a - (i.slidesPerView - 1) * C) / i.slidesPerView),
                i.roundLengths && (x = Math.floor(x)),
                c[g] && (c[g].style[t("width")] = `${x}px`);
            c[g] && (c[g].swiperSlideSize = x),
              f.push(x),
              i.centeredSlides
                ? ((T = T + x / 2 + S / 2 + C),
                  0 === S && 0 !== g && (T = T - a / 2 - C),
    ...
    events: {
      attachEvents: function () {
        ...
        (e.onTouchStart = x.bind(e)),
          ...
          (e.onClick = P.bind(e)),
          n.touch && !O && (t.addEventListener("touchstart", I), (O = !0)),
          A(e, "on");
      },
...
class _ {
  constructor(...e) {
    ...
    (i.__swiper__ = !0),
      (i.support = T()),
      (i.device = S({ userAgent: s.userAgent })),
      (i.browser = y()),
      (i.eventsListeners = {}),
  ...
  static use(e) {
    return Array.isArray(e)
      ? (e.forEach((e) => _.installModule(e)), _)
      : (_.installModule(e), _);
  }
}
function F(e, t, s, n) {
...
function H({ swiper: e, extendParams: t, on: s, emit: i }) {
  function n(t) {
    let s;
    return (
      t &&
  ...
  t({
    ...
    s("click", (t, s) => {
      const { $nextEl: n, $prevEl: a } = e.navigation,
        r = s.target;
      if (e.params.navigation.hideOnClick && !d(r).is(a) && !d(r).is(n)) {
        if (
          e.pagination &&
          e.params.pagination &&
...
function V({ swiper: e, extendParams: t, on: s, emit: i }) {
  ...
  function c() {
    ...
    if (
      ("fraction" === s.type &&
        (c.find(j(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
        c.find(j(s.totalClass)).text(s.formatFractionTotal(u))),
      "progressbar" === s.type)
    ) {
      let t;
  ...
  function u() {
    ...
    0 !== s.length &&
      ...
      t.clickable &&
        s.on("click", j(t.bulletClass), function (t) {
          t.preventDefault();
  ...
  function h() {
    ...
    s.removeClass(t.hiddenClass),
      ...
      t.clickable && s.off("click", j(t.bulletClass));
  }
  s("init", () => {
    u(), p(), c();
  }),
...
function W({ swiper: e, extendParams: t, on: s, emit: n }) {
  let a;
  function r() {
...
export { W as A, H as N, V as P, _ as S };
